...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            let elSpark1 = document.getElementById("cntTotalPosts");
            ...
            let elSpark2 = document.getElementById("cntRecentPosts");
            ...
            let elBar = document.getElementById("bar");
            ...
            let elDonut = document.getElementById("donut");
            let ChartDonut = new ApexCharts(elDonut, donut);

...
export default {
    ...
    methods: {
        async fetchMemberData() {
            ...
            let elSpark1 = document.getElementById("cntTotalMembers");
        ...
        async fetchCmntyData() {
            ...
            let elSpark2 = document.getElementById("cntTotalPosts");
        ...
        async fetchQnaData() {
            ...
            let elSpark3 = document.getElementById("cntRecentQna");

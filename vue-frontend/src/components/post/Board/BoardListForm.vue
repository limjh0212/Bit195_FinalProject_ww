                ...
                <template v-slot:default>
                    ...
                    <tfoot>
                        <div>
                            ...
                            |
                            <button v-if="myList">
                                <span @click="fetchData(1)">전체 보기</span>
                            </button>
                            <button v-else>
                                <span @click="fetchMyList(1)">내글 보기</span>
                            </button>
                        </div>
                        <div>
                            <div class="page-list">
                                <div v-for="page in items.pageList" v-if="myList" class="page-box" >
                                    <div class="page-box-default" @click="fetchMyList(page)">{{ page }}</div>
                                </div>
                                <div v-for="page in items.pageList" v-if="myList===false" class="page-box" >

    ...
    <v-container id="board-list-form">
        <div class="content-view">
            <div v-if="myList" class="mt-3 mb-3 d-fixed">
                <router-link class="board-btn btn-outline-primary mr-2" to="/post/OOTD">
                    <span class="btn-text">글 작성</span>
                </router-link>
                <button id="ootd-btn" class="board-btn btn-success" @click="fetchOotd">
                <span
            ...
            <div v-else class="mt-3 mb-3 d-fixed">
                ...
                <button id="fusionexport-btn" class="board-btn btn-success" @click="fetchMyImgList()">
              <span
                  class="spinner-border spinner-border-sm"
                  role="status"
                  aria-hidden="true"
            ...
            <div>
                <div class="main">
                    <table>
                        <tr class="ootd-line">
                            <td v-for="item in list()" id="card-form" class="card">
                                <div class="card-size">
